...
fdquery.SQL.Add('SET ');
fdquery.SQL.Add('RES_FALTAS = :RES_FALTAS, ');  //CAMPO DE ALTERAÇÃO
fdquery.SQL.Add('RES_AULAS_DADAS = :RES_AULAS_DADAS, ');  //CAMPO DE ALTERAÇÃO
fdquery.SQL.Add('RES_CC = :RES_CC, ');  //CAMPO DE ALTERAÇÃO
fdquery.SQL.Add('RES_CA = :RES_CA, ');  //CAMPO DE ALTERAÇÃO
fdquery.SQL.Add('RES_OBS = :RES_OBS ');  //CAMPO DE ALTERAÇÃO
